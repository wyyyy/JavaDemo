...
public class HttpRequestUtil {
	...
	public static String sendGet(String url, String param) {
		...
		try {
			...
			if (map.get("Content-Encoding").toString().toUpperCase()
					.equals("[GZIP]")) {
	...
	public static void main(String[] args) {
		// demo:代理访问
		String str = "city=南京&callback=flightHandler&callback=flightHandler&_=1441876100589";
		String url = "http://wthrcdn.etouch.cn/weather_mini";
		String para = "city=南京&callback=flightHandler&callback=flightHandler&_=1441876100589";
